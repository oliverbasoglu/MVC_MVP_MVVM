package com.obasoglu.mvc_mvp_mvvm.mvp.presenter;


import com.obasoglu.mvc_mvp_mvvm.model.Country;
import com.obasoglu.mvc_mvp_mvvm.model.CountryModel;
import com.obasoglu.mvc_mvp_mvvm.mvp.view.ActivityCountryView;
...
public class CountryPresenter {
    ...
    private ActivityCountryView view;
    private CountryModel model;


    public CountryPresenter(ActivityCountryView view) {
        this.view = view;
